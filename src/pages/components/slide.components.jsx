...
const SlideComponent = () => {
	const data = [
		{
			path: "/images/companies/1/07.webp",
			title: "1 MW Bolangir",
		},
		{
			path: "/images/companies/2/2.webp",
			title: "5MW Kadiri",
		},

		{
			path: "/images/companies/11/2.webp",
			title: "8MW Anakampoil",
		},
		{
			path: "/images/companies/hydro-epc.webp",
			title: "5MW Belij",
		},
		{
			path: "/images/companies/11/2.webp",
			title: "6 MW Peruvannamuzhy",
		},

		{
			title: "1MW Amritjal",
			path: "/images/companies/3/5.webp",
		},
		{
			title: "1 MW Barapole",
			path: "/images/companies/23/2.webp",
		},
	]
